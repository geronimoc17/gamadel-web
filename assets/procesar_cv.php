...
// Rutas
$upload_directory = "../../uploads/"; // Directorio temporal para guardar el archivo
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // El campo 'spam_check' está oculto en el HTML. Si un bot lo llena, es spam.
    // ----------------------------------------
    ...
    // ----------------------------------------
    // E. ENVÍO DEL CORREO CON ADJUNTO
    // Nota: Se utiliza la función mail() nativa de PHP.
    // ----------------------------------------
    ...
    if (mail($to_email, $subject, $email_message, $headers)) {
        ...
        $response['message'] = "Error al enviar el correo. Verifique la configuración del servidor.";
    }
